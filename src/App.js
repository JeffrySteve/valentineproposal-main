...
// Import GIFs - ensure files exist in src/
const flowerBear = require("./flowerBear.gif").default || "./flowerBear.gif";
const madBear = require("./madBear.gif").default || "./madBear.gif";
